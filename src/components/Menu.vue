<template>
  <menu class="menu">
    <ul class="menu__list">
      ...
      <li class="menu__item hover-link">
        <router-link
          to="/education"
          class="menu__link"
          :class="activeSection == 'education' ? 'active' : ''"
          @click="activeMenu('education')"
        >
          <svg
            width="18"
            height="18"
      ...
      <li class="menu__item hover-link">
        <router-link
          to="/experience"
          class="menu__link"
          :class="activeSection == 'experience' ? 'active' : ''"
          @click="activeMenu('experience')"
        >
          <svg
            width="18"
            height="18"
